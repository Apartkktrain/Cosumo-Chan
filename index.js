        ...
        message.channel.send({
            embed: {
                ...
                fields: [
                    {
                        name: "**宇宙鯖でお困りの方:**",
                        value: "<@&370968124977184782> へメンションでお知らせください。"
                    },
                    {
                        name: "**サーバーでフリーズした人：**",
                        value: "<@366612034672132107> にDMでお知らせください。"
                    },
                    {
                        name: "**コスモちゃんBotでお困りの方:**",
                        value: "<@586824421470109716> にメンションでお知らせください。"
                    },
                    {
                        name: "**HackCamの誤BANを解除申請:**",
                        value: "<#635108389927518219> までどうぞ。"
                    }
                ]
            }
        })
...
client.on('message', msg => {
    ...
    if(lastsendtime[msg.channel.id]) {
        ...
        return msg.reply({
            embed: {
                title: "警告：スパム検知",
                description: "警告により埋め込みを送信します。",
                color: 0xFF0000,
                timestamp: new Date(),
                fields: [
                    {
                        name: "**Reason：**",
                        value: "コマンドの実行リーチが短すぎます。"
                    },
                    {
                        name: "**解決方法：**",
                        value: "コマンド実行のスピードを遅くしましょう。"
                    }
                ]
            }
        })
